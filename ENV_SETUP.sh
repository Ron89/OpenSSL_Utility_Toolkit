...
# Possible values for CHOSEN_ARCH "excerpt from ./Configure --help":
...
# Cygwin-i686 Cygwin-x86 Cygwin-x86_64 DJGPP MPE/iX-gcc QNX6 QNX6-i386 UEFI UWIN 
# VC-CE VC-WIN32 VC-WIN64A VC-WIN64A-masm VC-WIN64I aix-cc aix-gcc aix64-cc 
# aix64-gcc android android-armeabi android-mips android-x86 android64 
# android64-aarch64 bsdi-elf-gcc cc darwin-i386-cc darwin-ppc-cc 
